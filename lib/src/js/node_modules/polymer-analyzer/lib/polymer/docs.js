 ...
 */
function annotateProperty(feature, ignoreConfiguration) {
    annotate(feature);
...
function _annotateFunctionProperty(scannedFunction) {
...
function featureElement(features) {
    ...
    return new polymer_element_1.ScannedPolymerElement({
...
function parsePseudoElements(comments) {
    ...
    comments.forEach(function (comment) {
        ...
        if (pseudoTag) {
            let element = new polymer_element_1.ScannedPolymerElement({
                tagName: pseudoTag,
