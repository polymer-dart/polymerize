...
suite('JavaScriptImportScanner', () => {
    let parser = new javascript_parser_1.JavaScriptParser({ sourceType: 'module' });
    let scanner = new javascript_import_scanner_1.JavaScriptImportScanner();
    test('finds imports', () => __awaiter(this, void 0, void 0, function* () {
        let file = fs.readFileSync(path.resolve(__dirname, '../static/javascript/module.js'), 'utf8');
        let document = parser.parse(file, '/static/javascript/module.js');
        let visit = (visitor) => Promise.resolve(document.visit([visitor]));
        let features = yield scanner.scan(document, visit);
    ...
    test('skips non-path imports', () => __awaiter(this, void 0, void 0, function* () {
        let file = fs.readFileSync(path.resolve(__dirname, '../static/javascript/module-with-named-import.js'), 'utf8');
