...
function editorTests(editorFactory) {
    ...
    suite('getWarningsForFile', function () {
        ...
        function getUnderlinedText(warning) {
            return __awaiter(this, void 0, void 0, function* () {
                return '\n' + (yield warningPrinter.getUnderlinedText(warning.sourceRange));
            });
        }
        ...
        test(`Warn on imports of files that aren't found.`, () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.assert.equal(warnings.filter((warning) => warning.code === 'could-not-load')
                .length, 1);
            chai_1.assert.containSubset(warnings, [{ code: 'could-not-load', severity: warning_1.Severity.ERROR }]);
            chai_1.assert.deepEqual(yield getUnderlinedText(warnings[0]), `
