...
suite('HtmlCustomElementReferenceScanner', () => {
    suite('scan()', () => {
        ...
        const warningPrinter = new warning_printer_1.WarningPrinter(null, { analyzer: new analyzer_1.Analyzer({ urlLoader: loader }) });
        function getUnderlinedText(sourceRange) {
            return __awaiter(this, void 0, void 0, function* () {
                if (!sourceRange) {
                    return 'No source range produced';
                }
                return '\n' + (yield warningPrinter.getUnderlinedText(sourceRange));
            });
        }
        setup(() => {
        ...
        test('finds custom element references', () => __awaiter(this, void 0, void 0, function* () {
          ...
          <h1>Bar</h1>
            ...
            const sourceRanges = yield Promise.all(features.map((f) => __awaiter(this, void 0, void 0, function* () { return yield getUnderlinedText(f.sourceRange); })));
          ...
          ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`,
            ...
            const attrRanges = yield Promise.all(features.map((f) => __awaiter(this, void 0, void 0, function* () {
                return yield Promise.all(f.attributes.map((a) => __awaiter(this, void 0, void 0, function* () { return yield getUnderlinedText(a.sourceRange); })));
            })));
          ...
          <x-foo a=5 b="test" c></x-foo>
            ...
            const attrNameRanges = yield Promise.all(features.map((f) => __awaiter(this, void 0, void 0, function* () {
                return yield Promise.all(f.attributes.map((a) => __awaiter(this, void 0, void 0, function* () { return yield getUnderlinedText(a.nameSourceRange); })));
            })));
          ...
          <x-foo a=5 b="test" c></x-foo>
            ...
            const attrValueRanges = yield Promise.all(features.map((f) => __awaiter(this, void 0, void 0, function* () {
                return yield Promise.all(f.attributes.map((a) => __awaiter(this, void 0, void 0, function* () { return yield getUnderlinedText(a.valueSourceRange); })));
            })));
