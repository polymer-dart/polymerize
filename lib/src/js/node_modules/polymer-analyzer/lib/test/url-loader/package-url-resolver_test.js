...
suite('PackageUrlResolver', function () {
    suite('canResolve', () => {
        test('canResolve is true an in-package URL', () => {
            let r = new package_url_resolver_1.PackageUrlResolver();
        ...
        test('canResolve is false for URL with a hostname', () => {
            chai_1.assert.isFalse(new package_url_resolver_1.PackageUrlResolver().canResolve('http://abc.xyz/foo.html'));
        });
