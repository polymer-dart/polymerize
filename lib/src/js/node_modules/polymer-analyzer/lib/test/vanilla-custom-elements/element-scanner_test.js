...
suite('VanillaElementScanner', () => {
    ...
    suiteSetup(() => __awaiter(this, void 0, void 0, function* () {
        const parser = new javascript_parser_1.JavaScriptParser({ sourceType: 'script' });
        ...
        const scanner = new element_scanner_1.ElementScanner();
    ...
    test('Finds elements', () => {
        ...
        chai_1.assert.deepEqual(elementsList.map(e => e.superClass).sort(), [
            'HTMLElement',
            'HTMLElement',
            'HTMLElement',
            'HTMLElement',
...
//# sourceMappingURL=element-scanner_test.js.map
