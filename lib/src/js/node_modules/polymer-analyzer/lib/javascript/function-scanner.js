...
class FunctionVisitor {
    ...
    _initFunction(node, analyzedName, _fn) {
        ...
        this.functions.add(new function_1.ScannedFunction(functionName, description, summary, js_utils_1.getOrInferPrivacy(specificName, docs, true), node, docs, sourceRange, functionParams, functionReturn));
    }
}
