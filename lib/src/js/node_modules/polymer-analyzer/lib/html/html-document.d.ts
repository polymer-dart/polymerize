...
export declare class ParsedHtmlDocument extends ParsedDocument<ASTNode, HtmlVisitor> {
    ...
    protected _sourceRangeForElementWithEndTag(node: ASTNode): SourceRange | undefined;
    ...
    sourceRangeForAttributeValue(node: ASTNode, attrName: string): SourceRange | undefined;
