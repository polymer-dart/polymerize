...
class HtmlStyleScanner {
    scan(document, visit) {
        return __awaiter(this, void 0, void 0, function* () {
            const features = [];
            yield visit((node) => __awaiter(this, void 0, void 0, function* () {
                if (isStyleNode(node)) {
                    const tagName = node.nodeName;
                    if (tagName === 'link') {
                        const href = dom5.getAttribute(node, 'href');
                        const importUrl = url_1.resolve(document.baseUrl, href);
                        features.push(new model_1.ScannedImport('html-style', importUrl, document.sourceRangeForNode(node), document.sourceRangeForAttributeValue(node, 'href'), node));
                    }
                    else {
                        ...
                        features.push(new model_1.ScannedInlineDocument('css', contents, locationOffset, commentText, document.sourceRangeForNode(node), node));
                    }
                }
            }));
            return features;
